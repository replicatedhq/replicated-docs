  ...
  main: [
    "intro",
    {
      ...
      items: [
        ...
        "release-notes/rn-embedded-cluster-v3",
    ...
    items: [ // This list is generated. Do not edit.
      ...
      "reference/replicated-cli-notification",
      "reference/replicated-cli-notification-email",
      "reference/replicated-cli-notification-email-resend-verification",
      "reference/replicated-cli-notification-email-verify",
      "reference/replicated-cli-notification-event-type",
      "reference/replicated-cli-notification-event-type-ls",
      "reference/replicated-cli-notification-event",
      "reference/replicated-cli-notification-event-ls",
      "reference/replicated-cli-notification-event-retry",
      "reference/replicated-cli-notification-subscription",
      "reference/replicated-cli-notification-subscription-create",
      "reference/replicated-cli-notification-subscription-events",
      "reference/replicated-cli-notification-subscription-get",
      "reference/replicated-cli-notification-subscription-ls",
      "reference/replicated-cli-notification-subscription-rm",
      "reference/replicated-cli-notification-subscription-update",
      "reference/replicated-cli-notification-webhook",
      "reference/replicated-cli-notification-webhook-test",
      "reference/replicated-cli-policy",
      "reference/replicated-cli-policy-create",
      "reference/replicated-cli-policy-get",
      "reference/replicated-cli-policy-ls",
      "reference/replicated-cli-policy-rm",
      "reference/replicated-cli-policy-update",
