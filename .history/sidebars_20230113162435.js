...
const sidebars = {
  ...
  tutorialSidebar: [
    ...
    {type: 'link', label: 'Support & Troubleshoot', href:'/troubleshoot/index'},
    {
      type: 'category',
      label: 'Preflight Checks',
      items: [
        'troubleshoot/preflight/introduction',
        'troubleshoot/preflight/cluster-checks',
        'troubleshoot/preflight/node-checks',
        'troubleshoot/preflight/next-steps'
>>>>>>> 2b059f07 (Initial troubleshoot imbedding)
      ],
    },
  ],
};
