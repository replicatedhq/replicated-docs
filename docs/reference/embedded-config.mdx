...
For information about how to join nodes to a cluster with Embedded Cluster, see [Adding and Managing Nodes with Embedded Cluster](/enterprise/embedded-manage-nodes).
