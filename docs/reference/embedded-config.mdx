...
If you need to install Helm charts before your application and as part of the Embedded Cluster itself, you can do this with Helm extensions. One situation where this is useful is if you want to ship an ingress controller, because Embedded Cluster does not include one.
...
* The default service node port range is `80-32767`. Use ports within this range for any node port services you include in your Helm extensions.
