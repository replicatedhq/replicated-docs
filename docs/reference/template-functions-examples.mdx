    ...
    images:
      replicated-sdk: >-
        {{repl if HasLocalRegistry -}}
          {{repl LocalRegistryHost }}/{{repl LocalRegistryNamespace }}/replicated-sdk:v1.0.0-beta.21
        {{repl else -}}
          docker.io/replicated/replicated-sdk:v1.0.0-beta.21
        {{repl end}}
```
...
images:
  replicated-sdk: 'docker.io/replicated/replicated-sdk:v1.0.0-beta.21'
```
