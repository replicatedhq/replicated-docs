...
<img width="650px" alt="Boolean selector on the configuration screen" src="/images/config-screen-bool.png"/>
...
<img width="650px" alt="Dropdown item type on config screen" src="/images/config-screen-dropdown.png"/>

[View a larger version of this image](/images/config-screen-dropdown.png)

<img width="650px" alt="Dropdown item type expanded" src="/images/config-screen-dropdown-open.png"/>
...
<img width="650px" alt="File input field on the configuration screen" src="/images/config-screen-file.png"/>
...
<img width="650px" alt="Heading on the configuration screen" src="/images/config-screen-heading.png"/>
...
```
<img width="650px" alt="Email address label on the configuration screen" src="/images/config-screen-label.png"/>
...
<img width="650px" alt="Password text field on the configuration screen" src="/images/config-screen-password.png"/>
...
<img width="650px" alt="Select one field on the configuration screen" src="/images/config-screen-selectone.png"/>
...
<img width="650px" alt="Text field on the configuration screen" src="/images/config-screen-text.png"/>
...
You can use Go templates in the following item properties: `affix`, `default`, `help_text`, `name`, `title`, `value`, and `when`.

The following item properties do not support Go templates: `hidden`, `readonly`, `recommended`, `required`, `type`, and `validation`.
...
<h3 id="when-item"><code>when</code></h3>
...
<img width="750px" alt="Password validation error" src="/images/regex_password_validation_error.png"/>

[View a larger version of this image](/images/regex_password_validation_error.png)

<img width="750px" alt="File validation error only when uploaded" src="/images/regex_file_validation_error.png"/>
