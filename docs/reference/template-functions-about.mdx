...
Template functions have access to variables defined in other manifest files that are templated at the same time. This means that you can assign a template function to a variable in a manifest file, then use that variable in other manifest files.
