...
For the Config custom resource, KOTS templates each item separately. For information about the Config custom resource, see [Config](/reference/custom-resource-config).
