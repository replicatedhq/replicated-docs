...
<table>
  ...
  <tr>
    ...
    <td></td>
    <td>Prevents users from skipping this release during application upgrades. For more information, see <a href="/vendor/releases-promoting">Promoting and Editing Releases</a>.</td>
  </tr>
  <Token/>
  <tr>
