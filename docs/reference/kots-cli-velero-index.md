...
- [`print-fs-instructions`](kots-cli-velero-print-fs-instructions): (Deprecated) Prints instructions for setting up a file system as the snapshots storage destination (e.g., NFS or Host Path)
