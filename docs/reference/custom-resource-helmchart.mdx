...
The HelmChart v1 custom resource applies to the native Helm and Replicated Helm installations. For more information, see [About Distributing Helm Charts with KOTS](/vendor/helm-native-about).
