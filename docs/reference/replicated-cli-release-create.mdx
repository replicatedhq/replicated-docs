...
```
      --auto                               generate default values for use in CI (DEPRECATED: use a .replicated file instead)
  -y, --confirm-auto                       skip the confirmation prompt
  ...
  -h, --help                               help for create
      ...
      --notify-users                       When used with --promote <channel>, notify Enterprise Portal users of this release promotion
      ...
      --wait-for-airgap                    When used with --promote <channel>, wait for airgap bundle builds to complete (KOTS apps only)
      --wait-for-airgap-timeout duration   Timeout for waiting on airgap bundle builds (default 30m0s)
