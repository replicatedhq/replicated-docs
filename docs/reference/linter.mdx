...
<table>
  <tr>
    <th>Description</th>
    <td>
      <p>Enforces valid [RE2 regular expressions](https://github.com/google/re2/wiki/Syntax) pattern when regex validation is present.</p>
...
<table>
  <tr>
    ...
    <td>
      ...
      <p>kURL add-ons included in the Kubernetes installer must pin specific versions rather than <code>latest</code> or x-ranges (1.2.x).</p>
    </td>
  </tr>
  <tr>
    <th>Level</th>
