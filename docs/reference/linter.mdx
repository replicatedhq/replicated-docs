...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <p>Does not apply to Helm resources. Ignore any <code>nonexsistent-status-informer-object</code> warnings that appear for a Helm resource status informer.</p>
    </td>
  </tr>
</table>
