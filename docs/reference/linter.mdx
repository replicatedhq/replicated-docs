...
<table>
  <tr>
    <th>Description</th>
    <td>
      <p>Enforces valid RE2 regular expression pattern when regex validation is present.</p>
      <p>(TODO: Update path)For more information, see <a href="/reference/custom-resource-config#items">Items</a> in <em>Config</em>.</p>
    </td>
  </tr>
  <tr>
    <th>Level</th>
