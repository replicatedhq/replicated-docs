...
<table>
  ...
  <tr>
    <th>Applies To</th>
    <td>
    Helm v3 and above chart archives (<code>*.tar.gz</code>) that have a matching HelmChart custom resource. HelmChart custom resources with <code>helmVersion: v2</code> are skipped.
    </td>
  </tr>
</table>
