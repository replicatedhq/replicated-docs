...
The LintConfig custom resource does not support configuring the `nonexistent-status-informer-object` rule. For information about this rule, see [Linter Rules](linter#nonexistent-status-informer-object) in _Linter Rules_.
