...
* Fixes an issue where switching channels or syncing the license while installing an application update will skip upgrading the infrastructure, causing k0s and extensions to remain outdated.
