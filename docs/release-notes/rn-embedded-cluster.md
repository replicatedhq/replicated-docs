...
<table>
  <tr>
    <th>Version</th>
    <td id="center">2.19.13+k8s-1.36</td>
    <td id="center">2.19.13+k8s-1.35</td>
    <td id="center">2.19.13+k8s-1.34</td>
  </tr>
  <tr>
    <th>Kubernetes Version</th>
  ...
  <tr>
    <th>KOTS Version</th>
    <td colspan="3" id="center">1.132.0</td>
  </tr>
</table>

### Bug Fixes {#bug-fixes-2-19-13}
...
<table>
  <tr>
    <th>Version</th>
    <td id="center">2.19.12+k8s-1.36</td>
    <td id="center">2.19.12+k8s-1.35</td>
    <td id="center">2.19.12+k8s-1.34</td>
  </tr>
  <tr>
    <th>Kubernetes Version</th>
    <td id="center">1.36.2</td>
...
<table>
  <tr>
    <th>Version</th>
    <td id="center">2.19.11+k8s-1.36</td>
    <td id="center">2.19.11+k8s-1.35</td>
    <td id="center">2.19.11+k8s-1.34</td>
  </tr>
  <tr>
    <th>Kubernetes Version</th>
    <td id="center">1.36.2</td>
...
<table>
  <tr>
    <th>Version</th>
    <td id="center">2.19.10+k8s-1.36</td>
    <td id="center">2.19.10+k8s-1.35</td>
    <td id="center">2.19.10+k8s-1.34</td>
  </tr>
  <tr>
    <th>Kubernetes Version</th>
    <td id="center">1.36.2</td>
  ...
  <tr>
    <th>KOTS Version</th>
    <td colspan="3" id="center">1.131.8</td>
  </tr>
</table>
...
<table>
  <tr>
    <th>Version</th>
    <td id="center">2.19.9+k8s-1.36</td>
    <td id="center">2.19.9+k8s-1.35</td>
    <td id="center">2.19.9+k8s-1.34</td>
  </tr>
  <tr>
    <th>Kubernetes Version</th>
    <td id="center">1.36.2</td>
...
### Bug fixes {#bug-fixes-2-19-9}
* New installations with custom worker profiles now preserve the Embedded Cluster pod log directory unless the profile explicitly sets a different location.
...
<table>
  <tr>
    <th>Version</th>
    <td id="center">2.19.8+k8s-1.36</td>
    <td id="center">2.19.8+k8s-1.35</td>
    <td id="center">2.19.8+k8s-1.34</td>
  </tr>
  <tr>
    <th>Kubernetes Version</th>
    <td id="center">1.36.2</td>
...
### Improvements {#improvements-2-19-8}
