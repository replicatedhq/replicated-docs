...
### Bug Fixes {#bug-fixes-v2026-09-25-0}
* Fixed customer Manage pages loading under applications that the customer does not belong to.
## v2026.09.24-2
...
### New Features {#new-features-v2026-09-22-3}
* Enterprise Portal v2: KotsDownloadAssets and KurlDownloadAssets accept cliOnly so online pages can show KOTS/Preflight/Support Bundle CLIs without Admin Console or air-gap bundles.

## v2026.09.22-2

Released on September 22, 2026

### Bug Fixes {#bug-fixes-v2026-09-22-2}
* Fixed Enterprise Portal management controls and invitation eligibility for hybrid customers to follow their individual setting and the app-wide override.
* Fixed failed customer access saves leaving incorrect toggle state or an empty invitation dialog.
* Prevented management actions from becoming available before customer access settings finish saving.

## v2026.09.22-0

Released on September 22, 2026

### Bug Fixes {#bug-fixes-v2026-09-22-0}
...
### New Features {#new-features-v2026-09-15-6}
* Adds ability to filter custom metrics by name when setting up [Event Notifications](/vendor/event-notifications-manage).

### Improvements {#improvements-v2026-09-15-6}
* Team invite emails are now rate-limited, and the Reinvite action shows when an invite can be sent again.
## v2026.09.15-3

Released on September 15, 2026

### New Features {#new-features-v2026-09-15-3}
* The Enterprise Portal is now available to all entitled vendors in Beta, without a support request.
## v2026.09.15-2
...
### Improvements {#improvements-v2026-09-11-0}
* Release History under Channels can now be sorted by channel sequence, creation date, or semantic version. Version sorting is available only for channels that require semantic versions.

### Bug Fixes {#bug-fixes-v2026-09-11-0}
* Clarifies the Enterprise Portal Content tab fallback branch badge so it describes the default branch instead of implying per-release fallback behavior.
## v2026.09.10-0
...
### Bug Fixes {#bug-fixes-v2026-09-01-0}
* EPv2 Container Images modals now follow the active light or dark theme.
* Security Center now displays one consistent loading state while security report data is fetched.
## v2026.08.31-2
...
### Bug Fixes {#bug-fixes-v2026-08-28-0}
* Fixes a bug that would causes delays in release charts being pushed to Replicated registry.
## v2026.08.27-4
...
### Improvements {#improvements-v2026-08-25-6}
* Improved screen reader support for application icon previews and two-factor authentication setup.

## v2026.08.25-5

Released on August 25, 2026

### New Features {#new-features-v2026-08-25-5}
* Adds support for the /registry path in Proxy Registry.

### Bug Fixes {#bug-fixes-v2026-08-25-5}
* Fixed a brief loading-state flash where the Embedded Cluster install modal could show the wrong air-gap disabled reason before release versions finished loading.
* Clarified the error shown when a release promotion version does not match a Helm chart's \`Chart.yaml\` version.
...
### Bug Fixes {#bug-fixes-v2026-08-21-8}
* Fixed Portal Features permissions so vendors with existing custom application policies can configure all Security Center settings.

## v2026.08.21-6

Released on August 21, 2026

### Improvements {#improvements-v2026-08-21-6}
* Standardized Enterprise Portal status and error messages for a more consistent visual experience.

## v2026.08.21-3

Released on August 21, 2026

### New Features {#new-features-v2026-08-21-3}
* The Vendor Portal Security Center beta is now available by default to all vendor teams.
...
### Improvements {#improvements-v2026-08-19-6}
* Security Center is now labeled Beta throughout Vendor Portal.
...
### Bug Fixes {#bug-fixes-v2026-08-07-2}
* Fixed the release manifest file tree so releases with many YAML files can be scrolled.
...
### New Features {#new-features-v2026-06-08-0}
* Customers on new Enterprise Portal can now view update commands for the version an instance is already running.
...
### New Features {#new-features-v2026-05-27-3}
* Adds new Enterprise Portal component to list images in a Helm release.
...
### New Features {#new-features-v2026-05-15-3}
* Update Enterprise Portal V2 doc links.
...
### Improvements {#improvements-v2025-11-18-1}
* Adds a link to the Submit a Support Request documentation page.
