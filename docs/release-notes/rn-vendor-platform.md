...
* Adds the Replicated embedded cluster (Beta) distribution to the compatibility matrix. For more information, see [Using Embedded Cluster](/installer/embedded-overview).
...
* Enables the Embedded Cluster option on the customer license page. For more information, see [Using Embedded Cluster](/installer/embedded-overview).
