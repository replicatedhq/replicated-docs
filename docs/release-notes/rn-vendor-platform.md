...
* Added the ability to expose NodePorts on VM clusters in compatibility matrix.
* Added the ability to attach new S3 buckets to EKS clusters in compatibility matrix.
