...
* Adds [Rook add-on](https://kurl.sh/docs/add-ons/rook) verison 1.12.0, 1.12.1
* Fixes an issue where storage could not be moved from Longhorn to OpenEBS at the same time as Kubernetes was upgraded to 1.25+.
