...
:::important
[Velero add-on](https://kurl.sh/docs/add-ons/velero) versions 1.17 and later switch the file-system backup uploader from Restic to Kopia, which is not compatible with the Local Volume Provider (LVP). To continue using file-system backups after upgrading, you must migrate to a Kopia-compatible destination. For more information, see [Migrate from Local Volume Provider (LVP) to a Kopia-compatible destination](https://docs.replicated.com/enterprise/snapshots-velero-upgrading#migrate-from-local-volume-provider-lvp-to-a-kopia-compatible-destination).
:::
...
* Adds [Velero add-on](https://kurl.sh/docs/add-ons/velero) version 1.18.2.
...
### New Features {#new-features-v2026-05-18-0}
* Adds [Kubernetes](https://kurl.sh/docs/add-ons/kubernetes) version(s) 1.35.4 1.34.7 1.33.11 1.32.13.
* Adds [Prometheus add-on](https://kurl.sh/docs/add-ons/prometheus) version 0.90.1-84.5.0.
* Adds [Registry add-on](https://kurl.sh/docs/add-ons/registry) version 3.1.1.
* Adds [EKCO add-on](https://kurl.sh/docs/add-ons/ekco) version 0.28.14.
...
### New Features {#new-features-v2026-05-05-0}
* Adds [Prometheus add-on](https://kurl.sh/docs/add-ons/prometheus) version 0.90.1-84.1.2.
* Adds [Cert Manager add-on](https://kurl.sh/docs/add-ons/cert-manager) version 1.20.2.
* Adds [Flannel add-on](https://kurl.sh/docs/add-ons/flannel) version 0.28.4.
...
### New features {#new-features-v2026-02-10-0}
* Adds [Cert Manager add-on](https://kurl.sh/docs/add-ons/cert-manager) version 1.19.3.
* Adds [Metrics Server add-on](https://kurl.sh/docs/add-ons/metrics-server) version 0.8.1.
* Adds [Prometheus add-on](https://kurl.sh/docs/add-ons/prometheus) version 0.88.1-81.5.0.
* Adds [Flannel add-on](https://kurl.sh/docs/add-ons/flannel) version 0.28.1.
...
### New features {#new-features-v2025-08-29-0}
* Adds [EKCO add-on](https://kurl.sh/docs/add-ons/ekco) version 0.28.11.
...
### New features {#new-features-v2025-08-07-0}
* Adds [Kubernetes](https://kurl.sh/docs/add-ons/kubernetes) version(s) 1.32.7 1.31.11 1.30.14 1.29.15.
* Adds [Rook add-on](https://kurl.sh/docs/add-ons/rook) verison 1.17.6.
* Adds [Flannel add-on](https://kurl.sh/docs/add-ons/flannel) version 0.27.1.
* Adds [Registry add-on](https://kurl.sh/docs/add-ons/registry) version 3.0.0.
* Adds [Containerd add-on](https://kurl.sh/docs/add-ons/containerd) version 1.7.27.
* Adds [OpenEBS add-on](https://kurl.sh/docs/add-ons/openebs) version 4.3.0.
* Adds [Prometheus add-on](https://kurl.sh/docs/add-ons/prometheus) version 0.82.2-72.9.0.
* Adds [MinIO add-on](https://kurl.sh/docs/add-ons/minio) version RELEASE.2025-07-23T15-54-02Z.
* Adds [Contour add-on](https://kurl.sh/docs/add-ons/contour) version 1.32.0.
* Adds [Flannel add-on](https://kurl.sh/docs/add-ons/flannel) version 0.27.2.
