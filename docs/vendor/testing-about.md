...
- Team actions with Compatibility Matrix (ex: creating and deleting clusters, requesting quota increases) are not currently logged and displayed in the [Vendor Team Audit Log](https://vendor.replicated.com/team/audit-log). 
