...
After installing, authorize the Replicated CLI using your Replicated credentials. See [Authenticate](/reference/replicated-cli-installing#auth) in _Install the Replicated CLI_.
...
1. To begin using the Replicated CLI to manage your applications, authenticate with your Replicated credentials. See [Authenticate](/reference/replicated-cli-installing#auth) in _Install the Replicated CLI_.
