...
* **Option 1: Use Compatibility Matrix.** You can use Replicated Compatibility Matrix to create and SSH onto Linux VMs. For more information, see [Create an Manage Environments with CMX](/vendor/testing-how-to).
...
* **Option 1: Use Compatibility Matrix.** You can use Replicated Compatibility Matrix to create clusters. For more information, see [Create an Manage Environments with CMX](/vendor/testing-how-to).
