...
Before you create the first release for the `cli-tutorial` application, first download a set of sample manifest files for a Kubernetes application that deploys an NGINX service.
