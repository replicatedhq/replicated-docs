...
There are additional steps to configure your releases to support installations in air-gapped environments. For more information, see [Support Air Gap Installations](replicated-onboarding-air-gap).
