...
# Replicated Onboarding (Replicated Installers and Helm CLI)
...
### Task 9: Alias Replicated Endpoints With Your Own Domains {#custom-domains}

<CustomDomains/>

1. If you added a custom domain for the proxy registry or app service, update the Embedded Cluster Config so that Embedded Cluster installations use your custom domains. See [Configure Embedded Cluster to Use Custom Domains](/vendor/custom-domains-using#ec).

### Task 10: Set Up the Enterprise Portal
