...
1. Security Center displays the results of the CVE scan in the Vendor Portal and both Enterprise Portal experiences:
   ...
   - **Enterprise Portal (New)**: Customers can view known vulnerabilities, per-image details, CVE reduction metrics when comparing versions, and the earliest vendor release that resolves each CVE.
