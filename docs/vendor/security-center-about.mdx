...
For technical details about the CVE scanning process, SBOM generation, and SecureBuild API integration, see [How Security Center Works](/vendor/security-center-how-it-works).
