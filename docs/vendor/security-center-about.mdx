...
Security Center intelligently filters vulnerability data based on installation type, ensuring customers only see relevant security information for their specific deployment type as each new release is promoted to their channel. When combined with the [Replicated SDK](/vendor/replicated-sdk-overview) you gain visibility into all container images running alongside your application, helping you identify security risks and urgent upgrade needs across your customer base. 
...
* **CVE Report**: Complete list of known vulnerabilities with severity levels
