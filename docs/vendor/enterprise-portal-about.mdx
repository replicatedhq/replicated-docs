...
For any enterprise customers using link transformers such as Microsoft Defender Safe Links, it is recommended that you ask to have your custom Enterprise Portal domain added to their list of trusted domains to prevent issues with rewrapping breaking legitimate URLs in Enterprise generated emails.
