...
The Enterprise Portal provides insights to end users about their active and inactive instances, including . For more information, see [View Active and Inactive Instances](/vendor/enterprise-portal-use#view-active-and-inactive-instances).

Additionally, the Enterprise Portal sends insights back to the Vendor Portal on the customer's installation attempts, . For more information, see [Enterprise Portal](/vendor/customer-reporting#enterprise-portal) and [Install Attempts](/vendor/customer-reporting#install-attempts) in _Customer Reporting_.
