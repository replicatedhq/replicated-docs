...
This topic describes how to configure and test Replicated Embedded Cluster.
...
The section describes managing nodes in clusters created with Replicated Embedded Cluster, including how to add or reset nodes.
