...
1. In a new release containing your application files, add a Velero Backup resource. For more information, see [Backup API Type](https://velero.io/docs/latest/api-types/backup/) in the Velero documentation.

1. The the release, add a Velero Restore resource.
