...
:::note
By default, every team has two policies created automatically: **Admin** and **Read Only**, regardless of which plan you are on. These default policies are not configurable.
:::
