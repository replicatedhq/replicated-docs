...
After you have a bundle, upload it to the Vendor Portal for analysis. You can also inspect the bundle locally with sbctl. For more information, see [Inspect Support Bundles](/vendor/support-inspecting-support-bundles).
