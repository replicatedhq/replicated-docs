...
You can create notifications for application instances, customers, support bundles, releases, channels, and platform-level usage.

For example, you can get a notification when an instance reaches a Ready state. You can also get notifications for support bundle uploads, expiring customer licenses, or monthly registry egress thresholds.
