...
## Key Differences from Classic Instance Notifications

Event Notifications offers significant improvements over the classic [Instance Notifications (Classic)](instance-notifications-config) system:

- **More event types available**: Covers customer events, support bundle events, release events, channel events, and more (not just instance events)
...
## Comparison: Classic vs. Event Notifications (Beta)
...
- [Instance Notifications (Classic)](instance-notifications-config) - Classic per-instance notification system
