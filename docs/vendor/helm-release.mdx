...
1. Create a new release or update an existing release. You can continue to update and lint an existing release until you are ready to promote it. Releases cannot be edited after they are promoted.
   ...
   For more information, see [release create](../reference/replicated-cli-release-create), [release update](../reference/replicated-cli-release-update), and [release promote](/reference/replicated-cli-release-promote) in the replicated CLI documentation.
