...
For mixed Classic and New Enterprise Portal teams, customer access is controlled per customer.
...
The Enterprise Portal endpoints are under the `enterprisePortal` tag.
