...
When the Security Center feature flag is enabled for the vendor and access is enabled for the customer, customers with Helm or Embedded Cluster installations can view security data for their releases.
