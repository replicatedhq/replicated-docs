...
For upgrades, customers use the **Instances & Updates** page. Helm and Embedded Cluster instance cards with an available update expand into generated CLI upgrade steps. KOTS and kURL cards do not expand: they show that in-portal updates are unavailable and direct the customer to upgrade in the Admin Console.
...
KOTS and kURL instance cards do not expand into CLI upgrade steps. The portal tells those customers to upgrade in the Admin Console. Helm and Embedded Cluster cards can still expand into generated CLI upgrades.
