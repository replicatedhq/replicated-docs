...
1. In the dialog that opens, follow the installation instructions to install.
   ...
   <TabItem value="helm" label="Helm" default> 
    ...
    <p>View the customer-specific Embedded Cluster installation instructions. For more information about installing with Embedded Cluster, see [Online Installation with Embedded Cluster](/embedded-cluster/v3/installing-embedded).</p>
