...
The **Release History** page for every channel in the Vendor Portal contains installation commands for specific releases.
...
For more information about installing with the Helm CLI, see [Installing with Helm](/vendor/install-with-helm).

For more information about installing with Embedded Cluster, see [Install](/vendor/embedded-overview#install) in _Using Embedded Cluster_. 