...
For email notification, no previous configuration is required.

## Configure Notifications

Follow this procedure to configure Slack or email notifications for one or more customer instances. You can enable notifications for just the application status, for all changes on the instance, and also disable notifications as needed.
