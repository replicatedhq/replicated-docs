...
This notification system is being replaced by [Event Notifications (Beta)](event-notifications), which offers more event types, better filtering, and improved delivery options. While this classic system continues to work, we recommend exploring Event Notifications for new notification configurations.

For a comparison of features, see [Comparison: Classic vs. Event Notifications](event-notifications#comparison-classic-vs-event-notifications-beta).
:::
...
- [Comparison: Classic vs. Event Notifications](event-notifications#comparison-classic-vs-event-notifications-beta) - Feature comparison