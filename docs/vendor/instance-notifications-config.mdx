...
Teams can receive notifications about customer insights through a Slack channel. Individual users can also receive email notifications.
...
Follow this procedure to configure Slack or email notifications for instances. 
...
1. From the **Configure Instance Notifications** dialog, select the **Slack Notifications** tab or use the default **My Notifications** tab for email notifications.
