...
- Check Security Center access: enable **Enable Security Center for all customers** under **Enterprise Portal > Content > Portal Features**, or enable **Enable Security Center for this customer** on the customer's **Enterprise Portal access** tab
