...
A channel release can be demoted from a channel. When a channel release is demoted, it will no longer be available for download, but it will not be withdrawn from environments where the release is already downloaded or installed. Its channel sequence and version will not be reused and for customer will appear to have been skipped. Un-demoting a release will restore its place in the channel sequence and make available for download and installation again.
