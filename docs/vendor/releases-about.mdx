...
A release contains your application files as well as the manifests required to install the application with the Replicated installers ([Replicated Embedded Cluster](/installer/embedded-overview) and [Replicated KOTS](../intro-kots)). 
