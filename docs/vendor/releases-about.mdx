...
* **Helm CLI**: When a release is demoted, the demoted release is no longer listed in the customer's Enterprise Portal as available for update, unless the customer had already downloaded the release before it was demoted.
