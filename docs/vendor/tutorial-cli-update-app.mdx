...
As a next step, you can continue to iterate on your application, using `replicated release create --auto` to promote each new release. For ideas on features and funcionality to add to your sample application, see [Iterating Your Releases](/vendor/distributing-workflow#iterating-your-releases) in _How to Package and Distribute a Production Application_.
