...
As a next step, you can continue to iterate on your application, using `replicated release create --auto` to promote each new release. For a list of KOTS features to integrate with your application, see [Onboarding with KOTS](/vendor/distributing-workflow).
