...
This procedure describes how to create a vendor portal account, install the replicated CLI on your local machine, and set up a `REPLICATED_API_TOKEN` environment variable to authenticate.
...
In the next step, you use the replicated CLI to create an application. Continue to [Step 2: Create an Application](tutorial-cli-create-app).
