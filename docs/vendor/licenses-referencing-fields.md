...
For more information about defining preflight checks for applications installed with KOTS, see [Define Preflight Checks for KOTS](vendor/preflight-kots-defining).
