...
This section provides information about managing GitHub user roles in the collab repository, including the default GitHub role mapping that the vendor portal uses, and how to change the default role for a user.
...
### Change the Default GitHub Role {#custom}
