...
This topic describes how to manage customer access to the Enterprise Portal (Classic) from the Replicated Vendor Portal. It includes information about enabling the Enterprise Portal, managing user invitations, enabling SAML authentication for Enterprise Portal logins, and more.

:::tip Looking for the new Enterprise Portal?
See [Manage Customer Access (New)](/vendor/enterprise-portal-v2-invite).
:::
