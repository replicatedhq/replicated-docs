...
KOTS versions v1.104.0 and later will discover support bundle specs from Secrets and ConfigMaps deployed to the cluster that have the `troubleshoot.sh/kind: support-bundle` label.
