...
The following example demonstrates how to link to a port-forwarded ClusterIP service for existing cluster installations, and also how to add a link to a NodePort service for kURL installations.
