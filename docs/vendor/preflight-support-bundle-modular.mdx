...
* In addition to your shared collectors and analyzers, you will also likely need to define other collectors and analyzers that are included in support bundles only. This is because some of the information used for troubleshooting (such as logs) is not necessary when running preflight checks before installation. Conversely, you should not have any collectors and analyzers that are included in preflight checks only.
