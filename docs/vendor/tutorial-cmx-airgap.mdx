...
1. Under **Virtual Machines**, after your VM is "Running", copy the SSH command provided.
...
1. (Optional) In a browser, go to the Admin Console. The Admin Console is available at the URL for the DNS record that you created with a target port of 30000 as part of [Create a VM with CMX](#create-a-vm-with-cmx).
