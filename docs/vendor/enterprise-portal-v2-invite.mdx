...
Only users with email addresses matching an allowed domain can be invited. This prevents accidental invitations to personal email addresses or unauthorized domains. The allowed domain list also governs SAML logins. For more information, see [Just-in-time user provisioning](#jit-provisioning) below.
