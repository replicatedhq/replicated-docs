...
An installation UI helps less technical customers complete tasks like providing their license or configuring the deployment without editing YAML files directly. This reduces installation errors and support issues.
