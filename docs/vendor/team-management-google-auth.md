...
## Limitations
* Invitations for a team that are sent to a distribution list will be sent but are invalid and cannot be used to join a team when authenticating with Google authentication. 
