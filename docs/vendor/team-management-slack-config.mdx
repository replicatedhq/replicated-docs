...
While this feature is in alpha, only one slack channel per team is supported.

Notifications configuration actions do not currently support RBAC policies for granular permissions.
