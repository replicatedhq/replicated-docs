...
1. Under **Portal Features**, configure **Show only fixable CVEs in Security Center**:
...
1. Configure **Allow raw CVE scan downloads in Security Center**. This setting is disabled by default:
