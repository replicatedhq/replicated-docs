...
1. (Optional) Select **Enable semantic versioning** if it is not enabled by default. For more information about semantic versioning and defaults, see [Enabling Semantic Versioning](releases-semver-enabling).
