...
# Helm with SDK Release Workflow
...
Complete the following procedures to create and test a Helm release that includes the SDK:
...
After you install the first release for your application, return to the vendor portal to create a new release with additional SDK functionality. For more information, see [Add SDK Functionality](sdk-functionality-add)