...
1. Install the release using Helm or a Replicated installer. For more information, see:
     * **Emebdded Cluster**: [Online Installation with Embedded Cluster](/enterprise/installing-embedded)
     * **Helm**: [Installing with Helm](/vendor/install-with-helm)
     * **KOTS Existing Cluster**: [Online Installation in Existing Clusters](/enterprise/installing-existing-cluster)
     * **kURL**: [Online Installation with kURL](/enterprise/installing-kurl)
