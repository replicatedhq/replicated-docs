...
* If your application is deployed as multiple Helm charts, define your shared collectors and analyzers in the parent chart's templates. Defined templates created in the parent chart can be accessed by subcharts. This allows you to include the shared collectors and analyzers in any other support bundle specs that are created in subcharts.
