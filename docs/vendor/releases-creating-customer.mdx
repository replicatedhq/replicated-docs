...
1. For the built-in license options, enable any of the options that you want to support for the customer. For more information, see [Built-in License Fields](licenses-using-builtin-fields).
