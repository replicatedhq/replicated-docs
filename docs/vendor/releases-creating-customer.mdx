...
1. For **Customer email**, enter the email address for the customer.
   ...
   :::note
   If you enable the Enterprise Portal globally with auto-invite turned on, a **Send Enterprise Portal invite to customer email** checkbox appears on the Create a new customer page. When checked, the Vendor Portal sends an Enterprise Portal invitation to this email address. For more information, see [Automatically Invite Customers on Creation](enterprise-portal-invite#auto-invite).
   :::
