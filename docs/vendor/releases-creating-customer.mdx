...
1. Enable any of the available options for the customer. For more information about license options, see [Built-in License Fields](/vendor/licenses-using-builtin-fields). For more information about enabling install types for the license, see [Managing Install Types for a License (Beta)](/vendor/licenses-install-types).
