    ...
    The available license options are:
      ...
      <table>
        ...
        <tr>
          ...
          <td> <GitOpsNotRecommended/> Enables customers with a KOTS-managed installation to transition from click-to-deploy to a GitOps workflow for deployment. See <a href="/enterprise/gitops-workflow">Pushing Updates to a GitOps Workflow</a>. </td>
        </tr>
        <tr>
