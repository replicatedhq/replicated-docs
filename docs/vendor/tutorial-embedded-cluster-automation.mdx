...
For more information about headless installs with Embedded Cluster, see [Automating Installation with Embedded Cluster](/installer/installing-embedded-automation).