...
* `fieldName`: The data field that generated the event. For example, `appStatus`. 
...
This section describes each type of event that the vendor portal generates:

* [Application Status Events](#app-status)
...
* **Label**: The label for the event that displays in the **Instance Activity** stream in the vendor portal **Instance Details** page. For more information, see [Instance Activity](instance-insights-details#instance-activity) in _Instance Details_.
