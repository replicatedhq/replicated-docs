...
You can also set or clear the default application using the Vendor API. Send a `PUT` request to `/v3/team/default-app` with the following body:

```json
{"default_app_id": "YOUR_APP_ID"}
```

To clear the default, send:
