...
This topic describes how to use Replicated Compatibility Matrix (CMX) VMs, including information about supported types, creating and managing VMs, SSH access, and transferring files.
