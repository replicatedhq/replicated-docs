...
After creating and downloading the license file for a customer, you can continue to [Step 6: Install the App Manager](tutorial-cli-install-app-manager) to get the installation commands from the Unstable channel and install the Replicated app manager components on your Kuberentes cluster. 
