...
1. Run the following command to create a license for a customer named `Some-Big-Bank` that is assigned to the Unstable channel and expires in 10 days:
...
1. Rename the license file and save it to your Desktop:
...
After creating and downloading the license file for a customer, you can continue to [Step 6: Install the App Manager](tutorial-cli-install-app-manager) to get the installation commands from the Unstable channel and install the Replicated app manager components on your Kubernetes cluster. 
