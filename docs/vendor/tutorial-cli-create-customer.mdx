...
1. From the `replicated-cli-tutorial` directory, run the following command to create a license for a customer named `Some-Big-Bank` that is assigned to the Unstable channel and expires in 10 days:
