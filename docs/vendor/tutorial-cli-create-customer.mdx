...
Continue to [Step 6: Install KOTS and the Application](tutorial-cli-install-app-manager) to get the installation commands from the Unstable channel and install the KOTS components and the sample application in your cluster.
