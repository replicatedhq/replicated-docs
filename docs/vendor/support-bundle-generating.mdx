...
For KOTS installations, users can also generate support bundles from the KOTS Admin Console. For more information, see [Generating Support Bundles](https://docs.replicated.com/enterprise/troubleshooting-an-app) in the KOTS documentation.
