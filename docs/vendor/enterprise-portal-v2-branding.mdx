...
On a custom domain, you can remove the footer entirely by omitting these fields or setting `loginFooterText` to an empty string. For how to add a custom domain, see [Configure a Custom Domain](/vendor/enterprise-portal-v2-domains).
