...
You can expose ports on a VM and make them accessible on the public internet. For information about exposing ports using the CLI, see [replicated vm port expose](/reference/replicated-cli-vm-port-expose).
