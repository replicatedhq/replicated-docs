...
In order to access VMs that you create with CMX, you need to set up SSH access. You can do this using your personal GitHub account or a GitHub service account used by your team.
