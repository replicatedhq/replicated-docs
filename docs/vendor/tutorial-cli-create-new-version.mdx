...
In this step, you make an edit to the Replicated Config custom resource manifest file in the `replicated-cli-tutorial/manifests` directory for the `cli-tutorial` application to create a new field on the **Config** page in the admin console. You will then create and promote a new release to the Unstable channel with your changes.
