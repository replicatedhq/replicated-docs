...
1. Ask your customer to collect a support bundle using one of the following methods. See [Generating Support Bundles](/enterprise/support-bundle-generating).
