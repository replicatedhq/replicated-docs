...
The following diagram demonstrates how air gap telemetry is collected and stored by the SDK in a customer environment, and then shared to the vendor portal in a support bundle:
