...
This topic describes how to enable Enterprise Portal (Classic) self-service sign-ups. This allows users to access your application by signing up for Trial or Community licenses through the Enterprise Portal.

:::tip Looking for the new Enterprise Portal?
See [Enable Self-Service Sign-Ups (New)](/vendor/enterprise-portal-v2-self-serve-signup).
:::
