---
sidebar_label: Service Account Automation
---
...
This topic describes how to add service account automation docs to the new Enterprise Portal.

Service account automation lets your customers call Enterprise Portal API endpoints from CI/CD systems or other scripts.

Customers can use these endpoints to create install profiles, get structured install and update instructions, and download referenced artifacts.

The Enterprise Portal content template includes components that render customer-facing API documentation inside the customer's portal.

These components help you document automation without maintaining endpoint tables or example workflows by hand.
