...
<table>
  ...
  <tr>
    <td>team/integration/[:integrationId]/delete</td>
    <td>Grants the holder permission to delete specified integration(s).</td>
  </tr>
  <tr>
    <td>kots/app/[:appId]/channel/[:channelId]/releases/airgap/download-url</td>
    <td>Grants the holder permission to get an airgap bundle download URL for any release on the specified channel.</td>
  </tr>
  <tr>
    <td>integration/catalog/list</td>
    <td>Grants the holder permission to view team's integrations.</td>
  </tr>
</table>
