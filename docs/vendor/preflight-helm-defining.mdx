...
This topic provides a basic understanding and some key considerations about preflight checks for Helm charts and to help guide you in defining them for your application.
...
For KOTS installations, the preflight checks run automatically and KOTS looks for the preflights specified in the Helm chart archive.
