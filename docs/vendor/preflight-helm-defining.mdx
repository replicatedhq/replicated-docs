...
This topic provides information about creating a specification for preflight checks within a Helm chart. The information in this topic applies to Helm chart-based applications that are installed with Replicated KOTS or with the Helm CLI.
