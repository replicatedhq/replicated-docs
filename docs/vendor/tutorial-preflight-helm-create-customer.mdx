...
After promoting the release, create a customer so that you can install.
...
Optionally, install Gitea with KOTS to see how preflight checks automatically run in the KOTS admin console installation.
