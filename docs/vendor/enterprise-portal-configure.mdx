...
By default, these instructions will be shown to customers for each channel. If you wish to provide channel-specific custom instructions, these can be set lower on the page under `Channel customizations`. 
