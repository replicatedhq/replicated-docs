...
<table>
  ...
  <tr>
    ...
    <td>Email address associated with the customer installation. Used for registry authentication as the username in Helm installation instruction.</td>
    <td>`customer@example.com`</td>
  </tr>
  <tr>
    <td><code>{`{installation.serviceAccountToken}`}</code></td>
    <td>Authentication token for the service account. Used for registry authentication as the password in Helm installation instruction.</td>
