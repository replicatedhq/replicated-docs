...
- **Enterprise Portal Invite Sent**: When an Enterprise Portal invite is sent to a user
- **Enterprise Portal Access Granted**: When the first user accesses the Enterprise Portal for that customer team
- **Enterprise Portal User Joined**: When a user joins an Enterprise Portal customer (invite acceptance, self-signup, or SAML JIT)
