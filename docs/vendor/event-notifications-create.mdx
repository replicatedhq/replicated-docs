...
As an Operations Manager, I want to be notified when monthly registry egress reaches an expected usage threshold so that I can investigate usage changes before the end of the billing period.
