...
6. Choose your notification delivery method:
   ...
   - For more information about webhook payload structure, signing, and delivery behavior, see [Configure Event Notification Webhooks (Beta)](event-notifications-webhooks).
