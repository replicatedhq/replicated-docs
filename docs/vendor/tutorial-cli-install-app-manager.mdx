...
The _app manager_ is the Replicated component that allows your application users to install, manage, and upgrade applications. Users can interact with the app manager through a user interface, called the Replicated admin console, or through a CLI, called the kots CLI.
