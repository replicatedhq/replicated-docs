...
1. Access the cluster and run the existing cluster installation script with the following flags to automatically upload the license file and run the preflight checks at the same time you run the installation.
