...
1. Access the cluster you provisioned as part of [Set Up the Environment](tutorial-cli-setup#set-up-the-environment). From a location where you can access the cluster with the kubectl command line tool, run the `EXISTING` installation script from above:
