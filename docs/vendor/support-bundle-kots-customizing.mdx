...
This topic provides a basic understanding and some key considerations about support bundle specifications for KOTS installations to help guide you in customizing them for your application.
