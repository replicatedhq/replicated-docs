...
Welcome! This topic provides a quick start workflow to help you get started with the Replicated KOTS and Replicated Embedded Cluster installers.
...
* Installing and updating applications with Replicated Embedded Cluster
...
1. Create a new release and then perform an update in the Admin Console:

   1. In the `gitea` directory of your local filesystem, 
