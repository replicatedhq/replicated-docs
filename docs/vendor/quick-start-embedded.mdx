...
This quick start applies to users that will distribute their application with the Replicated KOTS and Replicated Embedded Cluster installers.
...
1. In your VM, update the application instance to the new version that you just promoted:
