...
* Installing releases on a VM with Embedded Cluster

* Using the KOTS Admin Console
...
1. Update the application instance to the new version that you just promoted:
...
For more information, see [KOTS and Embedded Cluster Onboarding](distributing-workflow).