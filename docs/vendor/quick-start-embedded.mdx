...
# KOTS and Embedded Cluster Quick Start

<Welcome/>

This quick start applies to applications that will be installed with the Replicated KOTS and Replicated Embedded Cluster installers. If your application will support Helm CLI installations only, see [Helm CLI-Only Quick Start](quick-start-helm).
