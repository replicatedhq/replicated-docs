...
1. (Helm Charts Only) If your release contains any Helm charts:
   ...
   1. Package the Helm charts into `.tgz` files. See [Creating a Helm Chart Package](helm-release-creating-package).

   1. Move the `.tgz` files to the local directory with your application files:
