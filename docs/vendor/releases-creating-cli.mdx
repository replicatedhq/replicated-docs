...
:::tip
You can use a `.replicated` configuration file to define your project structure and resource locations. See [.replicated Configuration File](/reference/cli-replicated-config).
:::
