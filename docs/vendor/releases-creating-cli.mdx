...
For applications that contain a single Helm chart, you can use the `--chart` flag to add your Helm chart to a release, rather than pointing to a local directory with your application files.
