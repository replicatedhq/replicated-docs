...
1. Initialize the project as a Git repository so that you can track your history. The replicated CLI also reads Git metadata to help with the generation of release metadata,
such as version labels.
