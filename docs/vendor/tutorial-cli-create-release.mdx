...
1. Run the following command to lint the application manifest files and ensure that there are no errors in the YAML:
  ...
  For a complete list of the possible error, warning, and informational messages that can appear in the ouput of the `release lint` command, see [Lint Rules](/reference/lint).
