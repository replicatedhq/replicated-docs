...
Now that the first release for the `cli-tutorial` applcation is promoted to a channel, you can complete the steps to install and deploy the application in a Kubernetes cluster. Continue to [Step 5: Create a Customer](tutorial-cli-create-customer) to create a customer license file that you will upload when installing the application.
