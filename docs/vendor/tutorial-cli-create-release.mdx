...
By default, Replicated includes the following release channels: Stable, Beta, and Unstable. The Unstable channel is intended for software vendors to use for internal testing. For more information about channels, see [About Release Channels](releases-about-channels).

To create and promote a release to the Unstable channel:

1. Run the following command to lint the application manifest files:
...
Continue to [Setp 5: Create a Customer](tutorial-cli-create-customer) to create a customer license file that you will use when installing the application.
