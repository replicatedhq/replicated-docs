...
# Define Preflight Checks for KOTS
 ...
 This topic provides a basic understanding and some key considerations about preflight checks for Replicated KOTS installations to help guide you in defining them for your application.
