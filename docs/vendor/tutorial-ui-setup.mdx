...
Before you begin this tutorial, ensure that you have one of the following:

* A Kubernetes cluster that you can access with the kubectl command line tool.
...
* A VM where the Kubernetes installer can create a cluster.
