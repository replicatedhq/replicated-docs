...
- A VM where the Kubernetes installer can create a cluster. The Kubernetes installer script installs and configures the kubectl command-line tool for you. For more information about minimum requirements for installations, see [Installation Requirements](/enterprise/installing-general-requirements).
