...
1. Do one of the following to log in to the Enterprise Portal:
    ...
    * **New user**: To log in to the Enterprise Portal as a new user, invite the user and then follow the login link provided in the invitation email. See [Invite Users](enterprise-portal-invite#invite-users).
