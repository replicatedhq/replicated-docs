...
Users can log in to the Enterprise Portal after they are invited to join. Or, if self-service sign-ups enabled for your application, users can create an account in the Enterprise Portal without being invited.

* **Self-service account creation:** Go to the sign-up page URL, enter your company name and email address, agree to the terms and conditions, and click **Create account**. Then, go to your email account and open the automated account creation email. Follow the link provided in the email to log in.

    :::note
    For more information about enabling self-service sign-ups for your application and sharing the unique sign up URL with current and prospective customers, see [Enable Self-Service Sign-Ups](/vendor/enterprise-portal-self-serve-signup).
    :::
...
* **Log in from the invitation email:** After you are invited to join an Enterprise Portal team, go to your email account and open the automated invitation email. Click **Activate your account** to log in. The following shows an example of an invitation email:
