...
1. On the panel on the left, select the installation type. The installation options available in the Enterprise Portal are based on the customer's license.
