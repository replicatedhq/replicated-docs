# Log in to and Use the Enterprise Portal (Classic)

This topic describes how to log in to the Replicated Enterprise Portal (Classic) as a user, and how to use the features in the Enterprise Portal.

:::tip Looking for the new Enterprise Portal?
See [Log in to and Use the Enterprise Portal (New)](/vendor/enterprise-portal-v2-use).
:::
