...
1. Import your application files to Replicated using one of the following types:
    ...
    <table>
      ...
      <tr>
        <td>Helm charts</td>
        <td>To create a release with your Helm chart, add your Helm chart and a Replicated HelmChart custom resource to the release. See <a href="releases-creating-releases">Managing Releases with the Vendor Portal</a> and <a href="helm-native-v2-using">Configuring the HelmChart Custom Resource</a>.</td>
      </tr>
      <tr>
