...
1. Test your release by installing it on a development server. You can use the server that you created if you completed one of the recommended tutorials in step 2. You can also create a development server by following the application installation procedures in the _Enterprise_ documentation. See [Overview of Installing an Application](../enterprise/installing-overview).
