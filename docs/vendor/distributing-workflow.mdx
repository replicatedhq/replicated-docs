...
### Step 0: Connect Your Image Registry and Enable the Proxy Service

[Connecting to an External Registry](/vendor/packaging-private-images)

### Step 1: Configure KOTS HelmChart
...
### Step 2: Add Embedded Cluster Config
...
### Step 3: Customize the KOTS Admin Console {#admin-console}
...
<a href="/vendor/admin-console-adding-buttons-links">Adding Application Links to the Dashboard</a>
...
### Step 4: Set Up the Admin Console Config Screen
...
### Step 5: Configure Preflight Checks and Support Bundles
...
### Step 6: Configure Backup and Restore
...
### Step 8: Customize Customer Licenses
...
### Customize Your Release Channels

### Set Up the Replicated CLI
