...
Software vendors can use the Replicated embedded cluster feature or Replicated kURL to create a custom Kubernetes distribution and support embedded cluster installations. For more information, see [Using Embedded Cluster](embedded-overview) or [Introduction to kURL](kurl-about).
