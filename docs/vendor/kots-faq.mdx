...
Software vendors can use Replicated Embedded Cluster or Replicated kURL to create a custom Kubernetes distribution and support embedded cluster installations. For more information, see [Using Embedded Cluster](/vendor/embedded-overview) or [Introduction to kURL](/vendor/kurl-about).
