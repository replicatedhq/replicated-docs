...
1. If there is not already a kURL installer promoted to the channel, add a kURL installer to the release to support embedded cluster installations with kURL. For more information, see [Creating a kURL installer](/vendor/packaging-embedded-kubernetes).
