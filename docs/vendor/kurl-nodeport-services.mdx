...
Users can access NodePort services by clicking a link to the service on the Admin Console dashboard. Additional configuration is required to add a link to the dashboard.
...
### Add a Link to the Admin Console Dashboard
