...
## About Linking to NodePort Services {#add-link}

After installation, you can provide access to NodePort services by adding a link to the service on the Admin Console dashboard. This is done by configuring the Kubernetes SIG Application custom resource. For more information, see [Adding Links to the Dashboard](admin-console-adding-buttons-links).
