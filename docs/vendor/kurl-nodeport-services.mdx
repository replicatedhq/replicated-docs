...
This topic describes how to create a NodePort service for exposing services in installations with Replicated Embedded Cluster or Replicated kURL. 
...
The following example demonstrates how to expose a basic NGINX service for both existing cluster and kURL installations.
