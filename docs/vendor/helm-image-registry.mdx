...
* Declare the Replicated SDK as a dependency in your Helm chart. See [How to Distribute the Replicated SDK](replicated-sdk-overview) in _About the Replicated SDK_.
