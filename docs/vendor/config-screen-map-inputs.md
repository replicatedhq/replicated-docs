...
To follow a tutorial that maps values from the configuration screen to a Helm chart, see [Map Config Values to a Helm Chart](/vendor/tutorial-config-setup).
