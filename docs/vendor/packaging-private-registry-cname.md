...
- The endpoints do not support CNAMEs for replicated.app (kots manifests), api.replicated.com (platform market API), the download portal, or other services. For information about the API endpoints, see [#supported-api-methods-for-cname].
