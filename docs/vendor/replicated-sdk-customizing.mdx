...
You can also use both methods together. When both an alias and `nameOverride` are set, `nameOverride` takes precedence and determines the names of the SDK resources in the cluster.
