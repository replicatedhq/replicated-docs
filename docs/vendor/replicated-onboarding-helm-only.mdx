...
:::note
Replicated recommends that you use Compatibility Matrix (CMX) to create an air-gapped environment for testing your releases. For more information, see [Create and Manage Environments with CMX](/vendor/testing-how-to).
:::
