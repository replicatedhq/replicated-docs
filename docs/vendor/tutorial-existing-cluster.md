# How to package applications on existing clusters

This guide explains how to package applications on exiting clusters.
...
This guide will deploy a basic application and shows you how to deliver an update to that application.
...
Now that you're familiar with the basics, you should run through the [CLI Quickstart](/vendor/quickstart-cli) so you can start managing your release YAML in a git repo.
