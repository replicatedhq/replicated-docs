...
To prevent KOTS or Helm-only customers from accessing a release that they cannot install, Replicated enforces the following channel assignment rules:
