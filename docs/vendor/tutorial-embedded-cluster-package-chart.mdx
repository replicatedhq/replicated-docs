...
1. In your local file system, go to the `gitea` directory that was created as part of [Step 1: Get the Sample Chart and Test](tutorial-embedded-cluster-get-chart).
...
Create a release using the Helm chart archive. See [Step 4: Add the Chart Archive to a Release](tutorial-embedded-cluster-create-release).
