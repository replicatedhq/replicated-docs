...
The new Enterprise Portal is a complete rebuild of the customer portal experience. It replaces two earlier experiences: the Classic Enterprise Portal, used by Helm and Embedded Cluster customers, and the Download Portal, used to share license files, air gap bundles, and install instructions, including for KOTS and kURL. What is new depends on which experience your customers use today.
