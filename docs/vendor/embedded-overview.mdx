...
* **Reach out about migrating from kURL**: We are helping several customers migrate from kURL to Embedded Cluster. See [here](https://docs.google.com/presentation/d/1ZNX_LnTDYhYiMNZFQayV2n_b8QuTSPfvtVoGwXbj7GI) for more information, and reach out to Alex Parker at alexp@replicated.com for more information.
