...
<img alt="Embedded cluster update in progress modal" src="/images/cluster-update-in-progress.png" width="550px"/>

[View a larger version of this image](/images/cluster-update-in-progress.png)
