...
* **Air gap support is in beta**: Support for air gap installations with Embedded Cluster is a beta feature. For more information, see [Air Gap Installation with Embedded Cluster (Beta)](/enterprise/installing-embedded-air-gap).
