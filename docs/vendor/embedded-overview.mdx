...
* **Custom domains not supported**: Embedded Cluster does not fully use custom domains even if they are configured. For more information about custom domains, see [About Custom Domains](/vendor/custom-domains). 
