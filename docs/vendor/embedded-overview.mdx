...
1. Set up a cluster with at least two controller nodes. You can do an online or air gapped installation. See Install and Add Nodes (Alpha) for more information. For air gap clusters, see Embedded Cluster Air Gap (Alpha).
