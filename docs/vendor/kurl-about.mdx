...
To distribute a kURL installer alongside your application, you can include the installer as a manifest file within a given release or promote the installer to a channel. For more information about creating kURL installers, see [Creating a kURL Installer](/vendor/packaging-embedded-kubernetes).
