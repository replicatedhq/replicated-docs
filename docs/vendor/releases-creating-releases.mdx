...
1. Click **Promote**. In the Promote Release dialog that opens, edit the fields:
  ...
  <tr>
    <td>Channel</td>
    <td>Select the channel where you want to promote the release.</td>
  </tr>
  <tr>
    <td>Version label</td>
    <td>
  ...
  <tr>
    <td>Requirements</td>
    <td>
      Select <strong>Prevent this release from being skipped during upgrades</strong> to mark the release as required. Applies only to releases that support installation with Replicated KOTS.
    </td>
  </tr>
  <tr>
    <td>Release notes</td>
