...
# Add Custom Resources to KOTS Releases

You use Replicated custom resources to add Replicated KOTS functionality to your KOTS releases. Custom resources are YAML files that you add to releases, depending on which options you want to use. 
