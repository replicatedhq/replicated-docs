...
This procedure shows you how to edit the Config screen for the application by logging into the admin console, which is a typical task performed by customers.
