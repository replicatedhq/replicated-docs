...
This procedure shows you how to make a configuration change for the application, which is a typical task performed by end users.
...
1. Enter the password that you created in [Step 6: Install KOTS](tutorial-cli-install-app-manager) to log in to the admin console.
