...
After you install KOTS, you can access the Replicated admin console. This procedure shows you how to make a configuration change for the application, which is a typical task performed by end users.
