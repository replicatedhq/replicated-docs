...
This procedure shows you how to edit the Config screen for the application, which is a typical task performed by customers.

To edit the Config screen:
...
1. (Optional) In your cluster, press Ctrl + C to exit the admin console.
