...
# Step 6: Run Preflight Checks and Install with KOTS

Create a KOTS-enabled release and then install with KOTS. This purpose of this step is to see how preflight checks are run from the KOTS admin console during installation.
