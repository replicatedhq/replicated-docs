...
Optionally, create a KOTS-enabled release and then install with KOTS. This purpose of this step is to see how preflight checks can be run from the KOTS admin console during installation.
