...
# Step 5b: Run Preflights with KOTS
...
1. On the license page, select the license file that you downloaded previously and click **Upload license**.
   ...
   ![Gitea preflight checks page](/images/gitea-preflights.png)

   [View a larger version of this image](/images/gitea-preflights.png)
