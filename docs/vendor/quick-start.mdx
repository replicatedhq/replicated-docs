...
For more information about setting up your environment to work with the Replicated Platform, see [Set Up Your Environment](/vendor/environment-setup).   
...
1. Install the application with Embedded Cluster:
   ...
   1. When prompted by the `install` command, set a password for accessing the Admin Console. You will use this password to log in to the Admin Console in a later step.
   ...
   1. If you are directed to the Admin Console landing page:
       ...
       1. On the **Certificate type** screen, either select **Self-signed** to continue using the self-signed Admin Console certificate or click **Upload your own** to upload your own private key and certificacte. By default, a self-signed TLS certificate is used to secure communication between your browser and the Admin Console. You will see a warning in your browser every time you access the Admin Console unless you upload your own certificate.
