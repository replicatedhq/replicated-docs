...
This topic provides a checklist of key Replicated features to integrate with your application to fully onboard onto the Replicated platform. 
...
* Package your application using Helm. For more information, see the [Helm documentation](https://helm.sh/).
...
These features are provided in a suggested order, though you can configure and test the features in any order.
