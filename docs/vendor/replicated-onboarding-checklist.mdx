...
This section provides a checklist of key Replicated features to configure and integrate with your application to fully onboard onto the Replicated platform. 

:::note
This checklist lists features in a suggested order, though you can configure and test features in any order.
:::
