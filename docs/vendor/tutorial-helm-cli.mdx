...
1. Access the Enterprise Portal for the customer to get the Helm CLI installatio instructions:
    ...
    1. Copy and run each of the commands provided to log in to the Replicated registry to access the chart images, install and run preflight checks, and then install.

1. Access your cluster:

     * If you are using Compatibility Matrix, create the cluster. Use the command provided to set your kubectl context to the cluster.

     * Otherwise, if you brought your own cluster, 
