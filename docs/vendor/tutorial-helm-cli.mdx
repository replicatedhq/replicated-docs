...
1. Add the chart archive to a new release:
   ...
   **Example output:**
   ...
   :::tip
   For automated workflows, you can create a `.replicated` configuration file to define your project structure and resources. This enables commands like `replicated release create --auto` to automatically discover and process resources without the `--yaml-dir` flag. See [.replicated Configuration File](/reference/cli-replicated-config).
   :::
