...
- Get insights into an instance's status by accessing telemetry data, which covers the health of the application, the versions that are currently running, and details about the infrastructure and clusters. For more information, see [Customer Reporting](/vendor/customer-reporting).
