...
The discovery method and merged support bundle method are supported on Replicated app manager v1.94.2 or later. To generate support bundles on earlier versions of app manager, see [Generate a Bundle using the CLI and Admin Console](#earlier-versions)
