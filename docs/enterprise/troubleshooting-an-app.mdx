...
>Introduced in app manager v1.94.2

:::note
To generate support bundles on earlier versions of app manager, see [Generate a Bundle using the CLI and Admin Console](#earlier-versions).
:::

<GenerateBundle/>


### Generate a Support Bundle using the CLI and Admin Console {#earlier-versions}
