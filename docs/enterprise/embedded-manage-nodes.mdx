...
1. Download and untar the Embedded Cluster installation assets. Ensure that the assets are available on the machine that you will join to the cluster.
...
1. SSH onto the machine to join to the cluster and then run the join command that you copied.
