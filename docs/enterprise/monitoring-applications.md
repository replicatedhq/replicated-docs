...
1. Log in to Grafana:
   ...
   * **Kubernetes installer provisioned cluster**: The Grafana password is randomly generated by kURL and is displayed on the command line after the Kubernetes installer provisions the cluster. To retreive the password, run the following kubectl command:
