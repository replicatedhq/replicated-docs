...
# Configuring Local Image Registries for KOTS Installations
...
In online (internet-connected) KOTS installations, you can optionally use a local private image registry. You can also disable the connection or remove the registry settings if needed.
