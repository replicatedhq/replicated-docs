...
|--------|-------------------|-------------------|-------------|
| Docker Hub    | Required    | Required    | Some dependencies of KOTS are hosted as public images in Docker Hub. The required domains for this service include `index.docker.io`, `cdn.auth0.com`, `*.docker.io`, and `*.docker.com.` |
