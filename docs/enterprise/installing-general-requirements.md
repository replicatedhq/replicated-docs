...
| kots.io              | Required                      | Not Required                  | The kots CLI makes requests to this domain when you are installing the kots CLI. This domain is owned by Replicated, Inc., which is headquartered in Los Angeles, CA.|
| github.com           | Required                      | Not Required                  | The kots CLI makes requests to this domain when you are installing the kots CLI. |
