...
| kots.io              | Required                      | Not Required                  | The kots CLI makes requests to this domain. This domain is owned by Replicated, Inc., which is headquartered in Los Angeles, CA.|
| github.com           | Required                      | Not Required                  | The kots CLI makes requests to this domain. |
