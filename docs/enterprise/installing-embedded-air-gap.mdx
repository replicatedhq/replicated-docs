...
After the air gap bundle is built, continue to [Update From the Admin Console](#upgrade-ui) or [Update From the Command Line](#upgrade-cli) to download the bundle and upgrade.    

### Update From the Command Line {#upgrade-cli}

To perform an upgrade from the command line:

<UpdateAirGapCli/>

### Update From the Admin Console {#upgrade-ui}
