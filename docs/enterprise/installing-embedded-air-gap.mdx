...
1. Move the downloaded `.tgz` to the air gapped VM where you will install. 

1. On your air gapped VM, untar the `.tgz` following the instructions provided in the **Embedded Cluster installation instructions** dialog. This will produce three files:
    * The installer
    * The license
