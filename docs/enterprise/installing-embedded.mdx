...
1. Run the first command in the **Embedded cluster install instructions** dialog to download the installation artifacts as a `.tgz`. This include the Embedded Cluster binary and the customer's license file.
