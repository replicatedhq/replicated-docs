...
# Managing Embedded Clusters

The topic describes managing nodes in clusters created with Replicated Embedded Cluster, including how to add or reset nodes. For information about adding nodes to kURL clusters, see [Adding Nodes to kURL Clusters](/enterprise/cluster-management-add-nodes).
...
## Access the Cluster with the CLI
