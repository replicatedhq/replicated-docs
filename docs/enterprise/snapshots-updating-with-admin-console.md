...
Additionally, if you used a Kubernetes installer that included the Velero add-on, Replicated recommends that you change the default internal storage because it is not sufficient for disaster recovery.
