...
This topic provides basic installation steps for installing applications with the Replicated KOTS admin console in different types of environments. For complete KOTS installation requirements, see [Installation Requirements](installing-general-requirements).

For CLI installation steps, see [Installing with the CLI](installing-existing-cluster-automation).
