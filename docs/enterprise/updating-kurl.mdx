...
This topic describes how to upgrade the versions of Kubernetes, Replicated KOTS, and kURL add-ons in a kURL cluster.
...
To perform an update in an online environment:
...
To perform an update in an air gap environment:
