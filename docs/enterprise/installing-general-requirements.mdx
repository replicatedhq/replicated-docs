...
The following ports need to be accessible from servers performing installations with Embedded Cluster:

* 2379/TCP (listening on localhost)
* 2380/TCP
* 4789/UDP
* 6443/TCP
* 7443/TCP
* 9091/TCP
* 9099/TCP (listening on localhost)
* 9443/TCP
* 10248/TCP (listening on localhost)
* 10249/TCP
* 10250/TCP
* 10256/TCP
* 10257/TCP (listening on localhost)
* 10259/TCP (listening on localhost)
* 30000/TCP
* 50000/TCP (listening on localhost). Required only for air gap installations.
