...
| proxy.replicated.com | Required&#42;                 | Required&#42;                 | Upstream Docker images are proxied through proxy.replicated.com. The on-prem docker client uses a license ID to authenticate to proxy.replicated.com. This domain is owned by Replicated, Inc which is headquartered in Los Angeles, CA.                                                                                                                       |
| registry.replicated.com | Required&#42;&#42;         | Required&#42;&#42;            | Some applications host private images in the Replicated private registry at this domain. This domain is owned by Replicated, Inc which is headquartered in Los Angeles, CA.
