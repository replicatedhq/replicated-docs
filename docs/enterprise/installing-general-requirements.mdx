...
| proxy-auth.replicated.com | Required&#42;                 | Required&#42;                 | In order to pull private images through proxy.replicated.com, the on-prem docker client first has to authenticate with this service using a license ID. This domain is owned by Replicated, Inc which is headquartered in Los Angeles, CA.                                                                                                                       |
