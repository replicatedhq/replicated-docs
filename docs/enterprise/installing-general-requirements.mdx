import DockerCompatibilityEnterprise from "../partials/image-registry/_docker-compatibility-enterprise.mdx"
...
Private registries are required for air gap installations. It is optional to use private registries for online installations.

The app manager has been tested for app manager compatibility with the following registries:

<DockerCompatibilityEnterprise/>
