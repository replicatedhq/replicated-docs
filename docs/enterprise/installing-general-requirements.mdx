...
| registry.replicated.com | Required &#42;&#42;        | Required &#42;&#42;           | Some applications host private Docker images in the Replicated private registry at this domain. This domain is owned by Replicated, Inc which is headquartered in Los Angeles, CA.
...
&#42;&#42; Required only if the application uses the Replicated private registry service. Contact your application vendor for more information.