:::note
Configuring notifications for cusotmer instance changes is in Alpha. To enable this feature on your account, log in to your vendor portal account. Select **Support** > **Request a feature**, and submit a feature request for "Instance Insights Notifications" - you can use [this link](https://vendor.replicated.com/support?requestType=feature&productArea=vendor&title=I+Would+Like+to+be+an+Instance+Insights+Notifications+Alpha+Tester) to access a pre-filled version of this form.
:::
