For KOTS installations, you can generate a support bundle using the default kots.io support bundle specification if the application does not have a support bundle spec included.
