You can generate a host support bundle for Replicated kURL clusters. Use this method when:
...
1. Do one of the following:
    ...
    - Save the host support bundle YAML file on the host. For more information about creating a YAML spec for a host support bundle, see [Configuring Host Support Bundles](/vendor/support-host-support-bundles).
