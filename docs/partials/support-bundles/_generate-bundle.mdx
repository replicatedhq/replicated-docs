...
You can manually generate a support bundle from one specification or generate a merged support bundle archive from multiple specifications.

#### Automatically Discover and Generate a Bundle

Run the following command to automatically discover all of the specifications contained in Secrets or ConfigMaps in the cluster and generate a merged support bundle:
