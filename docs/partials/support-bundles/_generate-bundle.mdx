...
- [Automatically discover cluster specifications](#discover)
- [Manually generate a support bundle from any specification type](#manual)
...
#### Manually Generate a Support Bundle {#manual}
