...
1. In the **New Service Account** dialog, enter a name the token in the **Nickname** field. Names for service accounts must be unique within a given team.

  <img alt="New Service Accounts Dialog" src="/images/service-account-create.png" width="400px"/>

  [View a larger version of this image](/images/service-accounts.png)
  
1. Select the RBAC policy from the dropdown list. Then select **Create Service Account**.
