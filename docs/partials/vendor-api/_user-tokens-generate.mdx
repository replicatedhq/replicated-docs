...
1. In the **New user API token** dialog, enter a nickname for the token. Select the required permissions or use the default **Read and Write** permissions. Then select **Create token**.
  :::note
