...
* Embedded Cluster requires that various ports are open and available. For more informationm see [Port Requirements](/enterprise/installing-general-requirements#port-requirements).