...
The Embedded Cluster UI requires that port 30080/TCP is open and available. Create a firewall opening for port 30080/TCP so that the end user can access the UI.
