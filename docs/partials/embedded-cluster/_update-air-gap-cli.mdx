...
1. From the Admin Console **Version history** page, click **Deploy** next to the new version.

   ![Version history page](/images/ec-upgrade-version-history.png)

   [View a larger version of this image](/images/ec-upgrade-version-history.png)Click **Deploy** next to the new version.
