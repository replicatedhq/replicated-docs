During installation, KOTS automatically generates a ConfigValues file. Users can download the ConfigValues from the Admin Console **View files** tab or with the [`kots get config`](/reference/kots-cli-get-config) command.
