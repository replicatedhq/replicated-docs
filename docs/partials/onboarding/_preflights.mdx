...
1. In your Helm chart `templates` directory, add a Kubernetes Secret that includes a preflight spec. See [Defining Preflight Checks](/vendor/preflight-defining).
...
1. Install the release to test your changes. Preflight checks run automatically during installation.
