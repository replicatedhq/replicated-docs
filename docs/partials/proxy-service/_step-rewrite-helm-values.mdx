For each image reference in your Helm chart values file, set the image repository URL to the location of the image in the proxy registry. This is either `proxy.replicated.com` or your custom domain.
