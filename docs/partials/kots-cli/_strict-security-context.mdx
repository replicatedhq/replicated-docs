<tr>
  ...
  <p>By default, KOTS Pods and containers are deployed with a security context that requires them to run as root. When <code>true</code>, <code>--strict-security-context</code> does the following:</p>
  <ul>
