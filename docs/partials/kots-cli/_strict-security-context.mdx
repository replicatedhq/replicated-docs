<tr>
  ...
  <td>bool</td>
  <td>
  <p>Set to <code>true</code> to explicitly enable strict security contexts for all KOTS Pods and containers. Might not work for some storage providers.</p>
  <p><code>--strict-security-context</code> does the following:</p>
  <ul>
