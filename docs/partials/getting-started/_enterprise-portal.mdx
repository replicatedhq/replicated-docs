...
1. (Recommended) Add a custom domain for the Enterprise Portal. See [Use Custom Domains](/vendor/custom-domains-using). You can also do this later as part of [Alias Replicated Endpoints With Your Own Domains](#custom-domains).
