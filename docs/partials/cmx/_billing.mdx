...
If you have a contract, you can purchase credits by logging in to the Vendor Portal and going to [**Compatibility Matrix > Buy $500 additional credits**](https://vendor.replicated.com/compatibility-matrix).
