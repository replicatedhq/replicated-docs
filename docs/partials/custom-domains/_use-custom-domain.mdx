After you configure one or more custom domains in the vendor portal, you assign a custom domain by setting it as the default for all channels or by assigning it to an individual release channel. These options can be used for registries and the download portal.
