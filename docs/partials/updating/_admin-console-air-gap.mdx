...
1. Click **Upload a new version** to upload a new version of the application.

   When you upload an update, a new upstream version displays in the list of available versions.
