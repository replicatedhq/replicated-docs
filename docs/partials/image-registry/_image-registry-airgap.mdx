...
For more information about registry requirements, see [Private Registry Requirements](enterprise/installing-general-requirements#private-registry-requirements).
