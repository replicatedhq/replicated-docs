...
1. (Optional) Test the `expires_at` field in your development environment:

   1. Create a port forward:
    
   1. In another tab, run the following command to verify that you can see the correct value for the `expires_at` field for the customer
