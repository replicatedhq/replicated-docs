  ...
  <div className={clsx("container")}>
    <div className={clsx("row")}>
      <div className={clsx("col", "col--4")}>
        <a
          href="https://www.youtube.com/watch?v=c28nVDiNo-M"
        ...
        >
          ...
          />
          <h3 className="get-started-box-title">Watch a demo</h3>
          <p className="get-started-box-subtitle">
            Get a full 45 minute deep dive into the Replicated platform.
          </p>
        </a>
      </div>
      <div className={clsx("col", "col--4")}>
