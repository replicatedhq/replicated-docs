        ...
        <div className="did-you-know-container">
          <div className="did-you-know-card">
            ...
            <p className="did-you-know-card-description">
              In the Vendor Portal, go to **Enterprise Portal > Customer Access
              > Email History** to see the delivery status of emails sent by the
              Enterprise Portal.
            </p>
            <a
              href="/vendor/enterprise-portal-invite#email-history"
