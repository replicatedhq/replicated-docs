(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('styled-components'), require('@xstyled/util'), require('react'), require('@xstyled/system')) :
  typeof define === 'function' && define.amd ? define(['exports', 'styled-components', '@xstyled/util', 'react', '@xstyled/system'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.xstyled = {}, global.styled, global.util, global.React, global.xstyledSystem));
}(this, (function (exports, scStyled, util, React, system) { 'use strict';
  ...
  var getMultiBorderStyle = /*#__PURE__*/getMultiDimensions(system.getBorderStyle);
  var propGetters = {
    // getSpace
    ...
    // getRadius
    'border-radius': /*#__PURE__*/getMultiDimensions( /*#__PURE__*/getNumber(system.getRadius)),
    'border-top-left-radius': /*#__PURE__*/getMultiDimensions( /*#__PURE__*/getNumber(system.getRadius)),
    'border-top-right-radius': /*#__PURE__*/getMultiDimensions( /*#__PURE__*/getNumber(system.getRadius)),
    'border-bottom-right-radius': /*#__PURE__*/getMultiDimensions( /*#__PURE__*/getNumber(system.getRadius)),
    'border-bottom-left-radius': /*#__PURE__*/getMultiDimensions( /*#__PURE__*/getNumber(system.getRadius)),
    // getBorder
    ...
    // getShadow
    'box-shadow': /*#__PURE__*/getMultiValues(system.getShadow),
    'text-shadow': /*#__PURE__*/getMultiValues(system.getShadow),
    // getSize
    width: getNumberSize,
  ...
  function styled(component) {
    return getCreateStyle(scStyled__default['default'](component));
  }
  var InnerBox = /*#__PURE__*/system.createSystemComponent(React__default['default']);
  var Box = /*#__PURE__*/styled(InnerBox)(createBox);
  styled.box = /*#__PURE__*/styled(Box);
  Object.keys(scStyled__default['default']).forEach(function (key) {
    styled[key] = styled(key);
    styled[key + "Box"] = styled(Box.withComponent(system.createSystemComponent(React__default['default'], key)));
  });
  ...
  function useTheme() {
    return React__default['default'].useContext(scStyled.ThemeContext);
  }
