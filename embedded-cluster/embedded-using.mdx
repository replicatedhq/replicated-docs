...
Redactors continue to use `v1beta2`. The `v1beta3` requirement applies only to the Preflight custom resource, not to HostPreflight, SupportBundle, or Redactor specs. See [Add preflight checks](#preflights) on this page.
