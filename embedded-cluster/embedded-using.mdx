...
:::note
Required application preflight checks are honored in Embedded Cluster TKVERSION and later. In earlier v3 releases, `strict: true` was accepted in the spec but did not prevent a user from continuing past the failure.
:::
