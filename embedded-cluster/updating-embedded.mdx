...
If you need to redeploy or reconfigure an instance without upgrading to a later application version, include the installation assets for the application version that is already installed when you perform the upgrade.
