...
Running `shell` requires command-line access to a node. There is no browser equivalent. For what end users can do without that access, see [Access required for common operations](embedded-persistent-console#operator-access).
