...
In the following example, replace `EC_VERSION` with the version of Embedded Cluster to install. For the available versions, see [Embedded Cluster v3 release notes](/release-notes/rn-embedded-cluster-v3).
